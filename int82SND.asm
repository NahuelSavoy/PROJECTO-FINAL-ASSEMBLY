...
InstalarInt:
  mov AX,3582h        ; Obtiene la ISR que esta instalada en la interrupcion
  int 21h    
       
  mov DespIntXX,BX    
  mov SegIntXX,ES

  mov AX,2582h    ; Coloca la nueva ISR en el vector de interrupciones
